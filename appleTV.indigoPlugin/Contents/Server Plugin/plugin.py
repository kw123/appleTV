...
####-------------------------------------------------------------------------####
	...
	def printHelpMenu(self,  valuesDict, typeId):
		...
		out += u"   for each apple tv it finds it will create a correcponding indigo device  \n"
		out += u"   you can exclude ip numbers from being considered  \n"
		...
		out += u"      try to use iphone remote app to connect to the appleTV. If that does not work, a power cycle/restart of the appleTV should fix it  \n"
		out += u"  \n"
